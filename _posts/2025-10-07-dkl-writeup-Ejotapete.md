...
tags: #writeup #eJPTv2 #HackingWeb #enumeración #Metasploit #RemoteAccessRCE #ReverseShell #InformationLekeage #EscaladaPrivilegios #SUIDexplotation  #SUDO
...
Con [[Metasploit]] ejecutaremos un exploit cual nos dará acceso a comandos y de ahí nos daremos una reverse Shell.
...
![[confrevshell_ejpt.png]]


Recibiendo así la shell vícitima.

![[recibirshellnc_ejpt.png]]
